...
// 1. TRUY VẤN CƠ BẢN (Category 4: Bàn phím văn phòng)
$sql = "SELECT * FROM san_pham WHERE category_id = 4";
...
// 3. LỌC THÔNG SỐ ĐỘNG (Tự động cập nhật theo Spec Keys trong Admin)
...
// 4. LỌC GIÁ (Quy đổi về triệu đồng theo yêu cầu của bạn)
...
<head>
  ...
  <link rel="stylesheet" href="css/keyoffice.css">
  <link rel="stylesheet" href="css/bootstrap-icons.css">
  <title>Bàn Phím Văn Phòng - Phong Cách Xanh</title>
</head>
<body>
  <header>
    <nav class="menu">
  ...
  <section class="mota">
    <img src="image/officekeybanner.webp" alt="" class="mota_img">
    <div class="mota-box">
      <p class="de">Bàn Phím Cơ Văn Phòng – Gõ Chính Xác, Layout Gọn, Bền Đáng Tin</p>
      <p>Bàn phím cơ văn phòng Filco là lựa chọn hàng đầu cho lập trình viên, nhân viên văn phòng và người làm việc chuyên sâu.</p>
      <p>Điểm nổi bật của bàn phím Filco: Switch cơ học chính hãng, thiết kế tối giản đúng chuẩn Nhật, độ bền 3-5 năm và bảo hành lên tới 5 năm.</p>
    </div>
  </section>
    ...
    <div class="main">
      <div class="khung_thanh_loc">
        <form action="" method="GET" id="filter">
          ...
          <div class="filter-box">
            ...
            <div class="filter-content">
              ...
              $brand_query = "SELECT DISTINCT th.id, th.name FROM thuong_hieu th 
                              JOIN san_pham sp ON th.id = sp.brand_id WHERE sp.category_id = 4";
          ...
          <?php
          // Tự động lấy các Spec Keys từ Database cho Category 4
          $keys_query = "SELECT DISTINCT spec_key FROM danhmuc_spec_keys WHERE category_id = 4"; 
              ...
              <div class="filter-box">
                ...
                <div class="filter-content">
                  ...
                  $val_query = "SELECT DISTINCT spec_value FROM thong_so 
                                ...
                                AND product_id IN (SELECT id FROM san_pham WHERE category_id = 4)";
          ...
          <div class="filter-box">
            ...
            <div class="filter-content">
              ...
              <label><input type="checkbox" name="price[]" value="3-4" onchange="this.form.submit()" <?= (isset($_GET['price']) && in_array('3-4', $_GET['price'])) ? 'checked' : '' ?>> Từ 3 đến 4 triệu</label><br>
              <label><input type="checkbox" name="price[]" value="4-6" onchange="this.form.submit()" <?= (isset($_GET['price']) && in_array('4-6', $_GET['price'])) ? 'checked' : '' ?>> Từ 4 đến 6 triệu</label><br>
            </div>
          </div>
        </form>
      </div>
